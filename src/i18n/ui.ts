...
export const ui = {
  en: {
    ...
    caseStudy: {
      kicker: 'Case study',
      title: 'Trinitrade — production-grade reliability on a $100 budget',
      ...
      metrics: [
        { value: '19', label: 'CloudFormation stacks — 100% IaC' },
        { value: '11', label: 'Grafana dashboards: infra · money path · SLOs' },
        { value: '7/7', label: 'strategy families tested → NO-GO, and I stopped' },
        { value: 'Mon–Fri', label: 'on only in market hours — off-hours ≈ $0' },
      ],
      captionGrafana: 'Sanitized Grafana — order latency & fill ratio',
      captionCloudwatch: 'Sanitized CloudWatch — SLO alarm, healthy',
      note: 'Dashboards and alarms shown are sanitized production captures. No P&L, no account identifiers.',
  ...
  es: {
    ...
    caseStudy: {
      ...
      title: 'Trinitrade — confiabilidad de grado producción con un presupuesto de $100',
      ...
      metrics: [
        { value: '19', label: 'stacks de CloudFormation — 100% IaC' },
        { value: '11', label: 'dashboards de Grafana: infra · ruta del dinero · SLOs' },
        { value: '7/7', label: 'familias de estrategia probadas → NO-GO, y paré' },
        { value: 'Lun–Vie', label: 'ON solo en horario de mercado — fuera ≈ $0' },
      ],
      captionGrafana: 'Grafana sanitizado — latencia de orden y ratio de fills',
      captionCloudwatch: 'CloudWatch sanitizado — alarma de SLO, sana',
      note: 'Los dashboards y alarmas mostrados son capturas de producción sanitizadas. Sin P&L, sin identificadores de cuenta.',
      cta: 'Lee el caso de estudio completo',
    },
    method: {
      kicker: 'Método',
      title: 'Cómo trabajo',
